...
| [1.2.2 Captions (Prerecorded)](https://www.w3.org/TR/WCAG20/#media-equiv-captions) | <ul><li>**Web**: Not Applicable</li><li>**Electronic Docs**: Not Applicable</li><li>**Software**: Not Applicable</li><li>**Authoring Tool**: Not Applicable</li> </ul> | <ul> </ul> |
| [1.2.3 Audio Description or Media Alternative (Prerecorded)](https://www.w3.org/TR/WCAG20/#media-equiv-audio-desc) | <ul><li>**Web**: Not Applicable</li><li>**Electronic Docs**: Not Applicable</li><li>**Software**: Not Applicable</li><li>**Authoring Tool**: Not Applicable</li> </ul> | <ul> </ul> |
| [1.3.1 Info and Relationships](https://www.w3.org/TR/WCAG20/#content-structure-separation-programmatic) | <ul><li>**Web**: Partially Supports</li><li>**Electronic Docs**: Supports</li><li>**Software**: Not Applicable</li><li>**Authoring Tool**: Supports</li> </ul> | <ul><li>**Web**: Most information is structured into logical relationships. Lists are well used to group information and provide navigation.  Forms do not have a visual or semantic representation for required fields.</li><li>**Electronic Docs**: Site has consistent information and relationships.</li><li>**Authoring Tool**: Site has consistent information and relationships.</li> </ul> |
| [1.3.2 Meaningful Sequence](https://www.w3.org/TR/WCAG20/#content-structure-separation-sequence) | <ul><li>**Web**: Supports</li><li>**Electronic Docs**: Supports</li><li>**Software**: Not Applicable</li><li>**Authoring Tool**: Supports</li> </ul> | <ul><li>**Web**: Site follows a correct reading sequence.</li><li>**Electronic Docs**: Site has consistent information and relationships.</li><li>**Authoring Tool**: Site has consistent information and relationships.</li> </ul> |
| [1.3.3 Sensory Characteristics](https://www.w3.org/TR/WCAG20/#content-structure-separation-understanding) | <ul><li>**Web**: Supports</li><li>**Electronic Docs**: Supports</li><li>**Software**: Not Applicable</li><li>**Authoring Tool**: Supports</li> </ul> | <ul><li>**Web**: Follows best practices.</li><li>**Electronic Docs**: Follows best practices.</li><li>**Authoring Tool**: Follows best practices.</li> </ul> |
| [1.4.1 Use of Color](https://www.w3.org/TR/WCAG20/#visual-audio-contrast-without-color) | <ul><li>**Web**: Supports</li><li>**Electronic Docs**: Supports</li><li>**Software**: Not Applicable</li><li>**Authoring Tool**: Supports</li> </ul> | <ul><li>**Web**: Color is used to a minimal extent.</li><li>**Electronic Docs**: Color is used to a minimal extent.</li><li>**Authoring Tool**: Color is used to a minimal extent.</li> </ul> |
...
| [2.1.1 Keyboard](https://www.w3.org/TR/WCAG20/#keyboard-operation-keyboard-operable) | <ul><li>**Web**: Partially Supports</li><li>**Electronic Docs**: Supports</li><li>**Software**: Not Applicable</li><li>**Authoring Tool**: Supports</li> </ul> | <ul><li>**Web**: Generally it is excellent, but the Review pages and pages with Long Text have some elements which cannot be activated with a keyboard. On the Long Text with discussion pages it is clear that the WYSIWYG, discussion emoji and file upload functionality also have no support for keyboard only users.</li><li>**Electronic Docs**: Supports keyboard users.</li><li>**Authoring Tool**: Supports keyboard users.</li> </ul> |
| [2.1.2 No Keyboard Trap](https://www.w3.org/TR/WCAG20/#keyboard-operation-trapping) | <ul><li>**Web**: Partially Supports</li><li>**Electronic Docs**: Supports</li><li>**Software**: Not Applicable</li><li>**Authoring Tool**: Supports</li> </ul> | <ul><li>**Web**: The Long Text pattern has no way to tab past the data entry block.</li><li>**Electronic Docs**: No keyboard traps were identified.</li><li>**Authoring Tool**: No keyboard traps were identified.</li> </ul> |
| [2.2.1 Pause, Stop, Hide](https://www.w3.org/TR/WCAG20/#time-limits-required-behaviors) | <ul><li>**Web**: Not Applicable</li><li>**Electronic Docs**: Not Applicable</li><li>**Software**: Not Applicable</li><li>**Authoring Tool**: Not Applicable</li> </ul> | <ul> </ul> |
...
| [2.3.1 Three Flashes or Below Threshold](https://www.w3.org/TR/WCAG20/#seizure-does-not-violate) | <ul><li>**Web**: Not Applicable</li><li>**Electronic Docs**: Not Applicable</li><li>**Software**: Not Applicable</li><li>**Authoring Tool**: Not Applicable</li> </ul> | <ul><li>**Web**: There are no flashing elements.</li><li>**Authoring Tool**: There are no flashing elements.</li> </ul> |
| [2.4.1 Bypass Blocks](https://www.w3.org/TR/WCAG20/#navigation-mechanisms-skip) | <ul><li>**Web**: Does Not Support</li><li>**Electronic Docs**: Does Not Support</li><li>**Software**: Not Applicable</li><li>**Authoring Tool**: Does Not Support</li> </ul> | <ul><li>**Web**: There are no skip link elements on the site for keyboard only users.</li><li>**Electronic Docs**: Similar issues 1.4.3 with Read the Docs default theme not including skip links.</li> </ul> |
| [2.4.2 Page Titled](https://www.w3.org/TR/WCAG20/#navigation-mechanisms-title) | <ul><li>**Web**: Supports</li><li>**Electronic Docs**: Supports</li><li>**Software**: Not Applicable</li><li>**Authoring Tool**: Supports</li> </ul> | <ul><li>**Web**: All pages include a meaningful title.</li><li>**Electronic Docs**: All pages include a meaningful title.</li><li>**Authoring Tool**: All pages include a meaningful title.</li> </ul> |
| [2.4.3 Focus Order](https://www.w3.org/TR/WCAG20/#navigation-mechanisms-focus-order) | <ul><li>**Web**: Supports</li><li>**Electronic Docs**: Supports</li><li>**Software**: Not Applicable</li><li>**Authoring Tool**: Supports</li> </ul> | <ul><li>**Web**: Focus ordering would be improved if action buttons were on the left of the screen.</li><li>**Electronic Docs**: Generally good but Previous/Next links are in reverse order.</li><li>**Authoring Tool**: Focusable components receive focus in an order that preserves meaning and operability.</li> </ul> |
| [2.4.4 Link Purpose (In Context)](https://www.w3.org/TR/WCAG20/#navigation-mechanisms-refs) | <ul><li>**Web**: Partially Supports</li><li>**Electronic Docs**: Partially Supports</li><li>**Software**: Not Applicable</li><li>**Authoring Tool**: Not Applicable</li> </ul> | <ul><li>**Web**: n some places links and buttons are described insufficiently to be understood in isolation. There are also empty links on some pages. The Django administration pages have many empty links.</li><li>**Electronic Docs**: Generally good, but Previous/Next buttons use titles to convey the title of the previous/next content on hover, but this isn’t accessible.</li> </ul> |
| [3.1.1 Language of Page](https://www.w3.org/TR/WCAG20/#meaning-doc-lang-id) | <ul><li>**Web**: Supports</li><li>**Electronic Docs**: Does Not Support</li><li>**Software**: Not Applicable</li><li>**Authoring Tool**: Supports</li> </ul> | <ul><li>**Web**: English is the only supported language and each page is properly defined.</li><li>**Electronic Docs**: Language of the page is commented out in the theme.</li><li>**Authoring Tool**: English is the only supported language and each page is properly defined.</li> </ul> |
| [3.2.1 On Focus](https://www.w3.org/TR/WCAG20/#consistent-behavior-receive-focus) | <ul><li>**Web**: Supports</li><li>**Electronic Docs**: Supports</li><li>**Software**: Not Applicable</li><li>**Authoring Tool**: Supports</li> </ul> | <ul><li>**Web**: Keyboard only users are able to control the focus of the page.</li><li>**Electronic Docs**: Keyboard only users are able to control the focus of the page.</li><li>**Authoring Tool**: Keyboard only users are able to control the focus of the page.</li> </ul> |
| [3.2.2 On Input](https://www.w3.org/TR/WCAG20/#consistent-behavior-unpredictable-change) | <ul><li>**Web**: Supports</li><li>**Electronic Docs**: Supports</li><li>**Software**: Not Applicable</li><li>**Authoring Tool**: Supports</li> </ul> | <ul><li>**Web**: Engaging with the interactive sites does not unexpectedly take control from the users.</li><li>**Electronic Docs**: The search elements of the site do not unexpectedly take control from the users.</li><li>**Authoring Tool**: Engaging with the interactive sites does not unexpectedly take control from the users.</li> </ul> |
| [3.3.1 Error Identification](https://www.w3.org/TR/WCAG20/#minimize-error-identified) | <ul><li>**Web**: Does Not Support</li><li>**Electronic Docs**: Not Applicable</li><li>**Software**: Not Applicable</li><li>**Authoring Tool**: Not Applicable</li> </ul> | <ul><li>**Web**: No error identification is currently built into the application.</li> </ul> |
| [3.3.2 Labels or Instructions](https://www.w3.org/TR/WCAG20/#minimize-error-cues) | <ul><li>**Web**: Partially Supports</li><li>**Electronic Docs**: Does Not Support</li><li>**Software**: Not Applicable</li><li>**Authoring Tool**: Not Applicable</li> </ul> | <ul><li>**Web**: There are some forms without labels in the current version. Generally the context is clear for most forms, but it should be improved. Date fields should be in a fieldset. The Django administration pages have many fields without labels.</li><li>**Electronic Docs**: There are no labels on the search.</li> </ul> |
| [4.1.1 Parsing](https://www.w3.org/TR/WCAG20/#ensure-compat-parses) | <ul><li>**Web**: Partially Supports</li><li>**Electronic Docs**: Supports</li><li>**Software**: Not Applicable</li><li>**Authoring Tool**: Not Applicable</li> </ul> | <ul><li>**Web**: Generally good. A few small instances of duplicate ID’s, tags not being closed, and empty headings. The Data Grid Question pattern includes edit/delete buttons that are not properly formed.</li><li>**Electronic Docs**: Generally very good but a few warnings.</li> </ul> |
| [4.1.2 Name, Role, Value](https://www.w3.org/TR/WCAG20/#ensure-compat-rsv) | <ul><li>**Web**: Partially Supports</li><li>**Electronic Docs**: Partially Supports</li><li>**Software**: Not Applicable</li><li>**Authoring Tool**: Not Applicable</li> </ul> | <ul><li>**Web**: There are some forms without labels in the current version. Generally the context is clear for most forms, but it should be improved. Date fields should be in a fieldset. The Django administration pages have many fields without labels.</li><li>**Electronic Docs**: There are no labels on the search forms.</li> </ul> |
...
| [1.4.5 Images of Text](https://www.w3.org/TR/WCAG20/#visual-audio-contrast-text-presentation) | <ul><li>**Web**: Not Applicable</li><li>**Electronic Docs**: Not Applicable</li><li>**Software**: Not Applicable</li><li>**Authoring Tool**: Not Applicable</li> </ul> | <ul> </ul> |
